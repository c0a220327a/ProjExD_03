...
class Bird:
    ...
    def __init__(self, num: int, xy: tuple[int, int]):
        ...
        """
        img0 = pg.transform.rotozoom(pg.image.load(f"ProjExD2023/ex03/fig/{num}.png"), 0, 2.0)  # 左向き，2倍
    ...
    def change_img(self, num: int, screen: pg.Surface):
        ...
        """
        self._img = pg.transform.rotozoom(pg.image.load(f"ProjExD2023/ex03/fig/{num}.png"), 0, 2.0)
...
class Bomb:
    ...
    爆弾に関するクラス
    """
    _colors = [(255, 0, 0), (255, 0, 0), (255, 0, 0), (255, 0, 0), (255, 0, 0), (255, 0, 0)]
    _dires = [-1, 0, +1]
    def __init__(self):
        """
        爆弾円Surfaceを生成する
...
class Explosion:
    ...
    def __init__(self, bomb: Bomb):
        self.explodes = [pg.image.load(f"ProjExD2023/ex03/fig/explosion.gif"), pg.transform.flip(pg.image.load(f"ProjExD2023/ex03/fig/explosion.gif"), True, True)]
        self.img = self.explodes[0]
        self._rct = self.img.get.rect()
        self._xy = bomb._rct.center
        self._life = 10
        ...
        if beam is not None:  # ビームが存在しているとき
            ...
            for i, bomb in enumerate(bombs):
                if beam._rct.colliderect(bomb._rct):
                    beam = None
                    screen.blit(pg.transform.rotozoom(pg.image.load(f"ProjExD2023/ex03/fig/explosion.gif"), 0, 5.0), [100,100])
                    del bombs[i]
